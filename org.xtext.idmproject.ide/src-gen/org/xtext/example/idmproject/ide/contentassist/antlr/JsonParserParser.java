...
public class JsonParserParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JsonParserGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInsertLeftAccess().getGroup(), "rule__InsertLeft__Group__0");
			builder.put(grammarAccess.getInsertRightAccess().getGroup(), "rule__InsertRight__Group__0");
			...
			builder.put(grammarAccess.getInstructionAccess().getInsertLAssignment_5(), "rule__Instruction__InsertLAssignment_5");
			builder.put(grammarAccess.getInstructionAccess().getInsertRAssignment_6(), "rule__Instruction__InsertRAssignment_6");
			builder.put(grammarAccess.getInstructionAccess().getModifyAssignment_7(), "rule__Instruction__ModifyAssignment_7");
			builder.put(grammarAccess.getInstructionAccess().getComputeAssignment_8(), "rule__Instruction__ComputeAssignment_8");
			builder.put(grammarAccess.getInstructionAccess().getGetAssignment_9(), "rule__Instruction__GetAssignment_9");
			builder.put(grammarAccess.getLoadAccess().getFileAssignment_1(), "rule__Load__FileAssignment_1");
			builder.put(grammarAccess.getSelectAccess().getKeyAssignment_1(), "rule__Select__KeyAssignment_1");
			...
			builder.put(grammarAccess.getInsertLeftAccess().getExpressionAssignment_1(), "rule__InsertLeft__ExpressionAssignment_1");
			builder.put(grammarAccess.getInsertRightAccess().getExpressionAssignment_1(), "rule__InsertRight__ExpressionAssignment_1");
			builder.put(grammarAccess.getInsertAccess().getKeyAssignment_1(), "rule__Insert__KeyAssignment_1");
			builder.put(grammarAccess.getInsertAccess().getExpressionAssignment_3(), "rule__Insert__ExpressionAssignment_3");
			builder.put(grammarAccess.getModifyAccess().getKeyAssignment_1(), "rule__Modify__KeyAssignment_1");
